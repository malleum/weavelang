...
var keywords = []Word{
	...
	{Name: "this", Section: "Holes",
		...
		Gloss: "the same token. This is the one `weave fmt` prints."},
	...
	{Name: "former", Section: "Holes",
		Means: "the first half of a Twine of two.",
		Gloss: "writing it says the value arriving is a pair and asks for it taken apart."},
	{Name: "latter", Section: "Holes",
		Means: "the second half of a Twine of two.",
		Gloss: "the other half of the same asking."},
	{Name: "fore", Section: "Holes",
		Means: "the first part of a Twine of three.",
		Gloss: "each width has its own words, so one word says both which part and how many there are."},
	{Name: "mid", Section: "Holes",
		Means: "the second part of a Twine of three.",
		Gloss: "the one between. `dupe` answers with a three, so this is where it was seen before."},
	{Name: "aft", Section: "Holes",
		Means: "the third part of a Twine of three.",
		Gloss: "a group may not mix the widths — `add former aft` says two and three at once."},
...
var talentWords = []Word{
	...
	{Name: "Ply", Means: "has its elements in order.",
		Gloss: "Bulk narrowed to what can be cut: `take`, `drop`, `sever`, `rev`. Thread and Air. A Web has a length and no order, which is why the two Talents are not one."},
}
