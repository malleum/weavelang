...
var glosses = map[string]string{
	...
	"take":      "the front of the Thread, sharing its storage. It bounds an endless producer.",
	...
	"head":      "`first` under another name, for those who reach for it.",
	"tail":      "everything but the head, on the same storage.",
	"rev":       "the same strands, laid the other way, on storage of its own.",
	...
	"pairs":     "every unordered two, each once, in the order they lay.",
	...
	"freq":      "a Web from each value to how often it lay there.",
	"most":      "the key `freq` counted highest.",
	"contains":  "is that Thread laid inside this one, unbroken.",
	...
	"bin":      "an Air of 31 and 30 read as the Earth it spells.",
